...
Secrets の扱いなどはブログ記事にまとめています。

▶ 記事：  
[GitHub ActionsでX自動投稿BOTを作る方法【無料・GUI操作で完結】](https://addache.net/github-post-1/)

## 注意

- このコードは学習・個人利用を想定しています
- X（旧Twitter）の利用規約・API制限は各自で確認してください
- 動作保証はありません（自己責任でお願いします）
